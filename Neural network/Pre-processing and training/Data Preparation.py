...
class VideoDataPreprocessor:
    ...
    def preprocess_data(self, num_frames=30, num_augmentations=4):
        for class_name in tqdm(os.listdir(self.data_dir), desc="Processing Classes"):
            ...
            if os.path.isdir(class_path):
                ...
                for video in tqdm(videos, desc=f"Processing {class_name} Videos", leave=False):
                    ...
                    class_data = self._process_video(class_name, video_path, num_frames, num_augmentations, class_data)
    ...
    def _process_video(self, class_name, video_path, num_frames, num_augmentations, class_data):
        ...
        '''
            Confidence:
                      Detection - threshold for the initial detection to be successful
        ...
        with mp_hands.Hands(min_detection_confidence=0.8, min_tracking_confidence=0.5, max_num_hands=2) as hands:
            ...
            while frame_count < num_frames:
                ...
                for augment_counter in range(num_augmentations):
                    ...
                    results = hands.process(processed_frame_landmarked)
    ...
    '''
        Results stores the coordinates of each point (landmark) on the hand 
        so x (landmark position in the horizontal axis), 
